...
## Geometry of Vector Addition and Column View {.tabset}

### Theorem 2.1. 
**Parallelogram Rule**

To add $\mathbf{v} \ \text{and} \ \mathbf{u}$, draw a parallelogram with vertices at the origin, $(v_1, v_2, \dots, v_n)$, and $(u_1, u_2, \dots, u_n)$. The fourth vertex of the parallelogram corresponds to the point $\mathbf{v} + \mathbf{u}$.
